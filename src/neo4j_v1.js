...
function Neo4jD3 (_selector, _options) {
  ...
  var container, graph, info, node, nodes, relationship, relationshipOutline, relationshipOverlay, relationshipText, relationships, selector, simulation, svg, svgNodes, svgRelationships, svgScale, svgTranslate,
    classes2colors = {
      'package': '#409EFF', // light blue#68bdf6
      'class': '#E6A23C', //
      'interface': '#faafc2', // light pink
      'exception class': '#f2baf6', // purple
      'error class': '#ff928c', // light red
      'field': '#fcea7e', // light yellow
      'construct method': '#ffc766', // light orange
      'enum class': '#405f9e', // navy blue
      'annotation class': '#a5abb6', // dark gray
      'xml attribute': '#78cecb', // green #2,
      'method': '#67C23A', // dark purple
      'enum constants': '#ced2d9', // light gray
      'primary type': '#e84646', // dark red
      'parameter': '#fa5f86', // dark pink
      'return value': '#6dce9e', // dark orange
      'exception condition': '#fcda19', // dark yellow
      'base override method': '#797b80', // black
      'value': '#c9d96f', // pistacchio
      'filed of class': '#47991f', // green #3
      'entity': '#70edee', // turquoise
      'wikidata': '#00ffbe',
      'domain term': '#b88cbb',
      'operation': '#004dff',
      'code_element': '#ff0086',
